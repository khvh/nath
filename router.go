...
func Get[O any](path string, handler echo.HandlerFunc, middleware ...echo.MiddlewareFunc) *Route {
	spec := spec.Get(path, zeroGeneric[O]())
...
func Delete[O any](path string, handler echo.HandlerFunc, middleware ...echo.MiddlewareFunc) *Route {
	spec := spec.Delete(path, zeroGeneric[O]())
...
func Post[O any, B any](path string, handler echo.HandlerFunc, middleware ...echo.MiddlewareFunc) *Route {
	spec := spec.Post(path, zeroGeneric[B](), zeroGeneric[O]())
...
func Put[O any, B any](path string, handler echo.HandlerFunc, middleware ...echo.MiddlewareFunc) *Route {
	spec := spec.Put(path, zeroGeneric[B](), zeroGeneric[O]())
...
func Patch[O any, B any](path string, handler echo.HandlerFunc, middleware ...echo.MiddlewareFunc) *Route {
	spec := spec.Patch(path, zeroGeneric[B](), zeroGeneric[O]())
